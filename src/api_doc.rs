...
#[openapi(
    paths(
        ...
        crate::handlers::notes::daily_note_counts,
        crate::handlers::notes::notes_by_date,
    ...
    components(
        schemas(
            ...
            crate::dto::notes::DailyNoteCount,
            crate::dto::notes::DailyNoteCountsResponse,
            crate::dto::notes::FieldNotesGroup,
            crate::dto::notes::FieldNotesResponse,
            ...
            crate::dto::notes::NotesByDateResponse,
            crate::dto::notes::RecentNotesRequest,
            crate::dto::notes::TaggedNotesGroup,
            crate::dto::notes::TaggedNotesResponse,
